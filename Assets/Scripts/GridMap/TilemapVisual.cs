...
public class TilemapVisual : MonoBehaviour 
{
    ...
    private void Awake() 
    {
        ...
        tilemapSpriteUVArray[0].uv00Pixels.x = 0;
        tilemapSpriteUVArray[0].uv11Pixels.x = 32;
        tilemapSpriteUVArray[0].uv00Pixels.y = 0;
        tilemapSpriteUVArray[0].uv11Pixels.y = 32;
